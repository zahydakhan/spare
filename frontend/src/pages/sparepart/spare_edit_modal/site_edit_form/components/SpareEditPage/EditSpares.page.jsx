...
import { editSparepartStart } from '../../../../../../redux/spareparts/spareparts.actions';
import { Alert as MuiAlert, AlertTitle } from '@material-ui/lab';
import { spacing } from '@material-ui/system';
const Alert = styled(MuiAlert)(spacing);

import SparepartEdit from './Forms/SpareEditForm';
...
export default function EditSpares({ setOpen, row }) {
	...
	async function _submitForm(values, actions) {
		...
		dispatch(editSparepartStart(edit_data));
		setSubmitError(''),
	...
	return (
		<React.Fragment>
			...
			>
				{({ isSubmitting }) => (
					<Form id={formId}>
						<SparepartEdit formField={formField} />
